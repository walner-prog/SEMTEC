<div class="space-y-6">
    ...
    <!-- Filtros -->
    <div
        class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-4 p-4 bg-white dark:bg-gray-800 rounded-xl shadow-md border border-gray-100 dark:border-gray-700">
        <!-- Grado -->
        <div>
            <label class="block text-sm font-medium text-gray-700 dark:text-gray-300">Grado</label>
            <select wire:model.live="grado_id"
                class="mt-1 block w-full border-gray-300 dark:border-gray-600 rounded-lg shadow-sm text-sm 
    ...
    <div class="bg-white dark:bg-gray-800 shadow-md rounded-lg overflow-hidden border border-gray-100 dark:border-gray-700">
        <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700 text-sm">
            <thead class="bg-gray-50 dark:bg-gray-700">
                <tr>
                    <th class="px-6 py-3 text-left font-semibold text-gray-600 dark:text-gray-300 uppercase tracking-wider">Estudiante</th>
                    <th class="px-6 py-3 text-left font-semibold text-gray-600 dark:text-gray-300 uppercase tracking-wider">Actividad</th>
                    <th class="px-6 py-3 text-left font-semibold text-gray-600 dark:text-gray-300 uppercase tracking-wider">Fecha</th>
                    <th class="px-6 py-3 text-left font-semibold text-gray-600 dark:text-gray-300 uppercase tracking-wider">Aciertos</th>
                    <th class="px-6 py-3 text-left font-semibold text-gray-600 dark:text-gray-300 uppercase tracking-wider">Errores</th>
                    <th class="px-6 py-3 text-left font-semibold text-gray-600 dark:text-gray-300 uppercase tracking-wider">Tiempo (seg)</th>
                    <th class="px-6 py-3 text-left font-semibold text-gray-600 dark:text-gray-300 uppercase tracking-wider">Puntaje</th>
                </tr>
            </thead>
                ...
                @forelse($intentos as $intento)
                    <tr class="hover:bg-gray-50 dark:hover:bg-gray-700/40 transition">
                        <td class="px-6 py-4 whitespace-nowrap text-gray-800 dark:text-gray-200">
                            {{ $intento->usuario->name }}
                        </td>
                        <td class="px-6 py-4 whitespace-nowrap text-gray-700 dark:text-gray-300">
                            {{ $intento->actividad->titulo }}
                        </td>
                        <td class="px-6 py-4 whitespace-nowrap text-gray-600 dark:text-gray-400">
                            {{ $intento->created_at->format('d/m/Y H:i') }}
                        </td>
                        <td class="px-6 py-4 text-green-600 dark:text-green-400 font-medium">{{ $intento->aciertos }}</td>
                        ...
                        <td class="px-6 py-4 font-semibold text-blue-600 dark:text-blue-400">{{ $intento->puntaje }}</td>
                    </tr>
                @empty
                    <tr>
