<div class="{{ $modoAccesible ? 'text-lg leading-8' : '' }} p-6
  ...
  <div class="flex flex-col md:flex-row md:justify-between md:items-center mb-6 gap-4 md:gap-0">
    <h2 class="text-2xl md:text-3xl font-extrabold text-center md:text-left text-gray-800 dark:text-gray-100 drop-shadow">
    ...
    <div class="flex flex-col sm:flex-row items-center sm:items-end md:items-center gap-3 md:gap-4 w-full md:w-auto justify-center md:justify-end">
        ...
        <div class="text-center sm:text-right w-full sm:w-auto">
            ...
            <div class="w-full sm:w-48 bg-gray-200 dark:bg-gray-700 rounded-full h-3 overflow-hidden mt-1">
                <div class="h-3 rounded-full transition-all duration-500" style="width: {{ $porcentajeProgreso }}%; background: linear-gradient(90deg,#34d399,#3b82f6)"></div>
            </div>
        ...
        <button 
            wire:click="toggleAccesibilidad" 
            ...
            <div class="flex flex-col gap-3">
                ...
                <div class="flex items-center justify-between gap-3 bg-yellow-50 dark:bg-gray-700 rounded-lg p-3">
                    <div class="flex items-center gap-3">
                        <div class="w-12 h-12 rounded-full bg-white dark:bg-gray-800 flex items-center justify-center shadow">
