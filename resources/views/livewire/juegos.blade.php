<div class="max-w-7xl mx-auto py-12 px-6">
    ...
    <div class="text-center mb-10 relative">
        ...
        <div class="flex justify-center gap-6 mt-6">
            ...
            <!-- Puntos -->
            <div
                class="bg-yellow-100 dark:bg-yellow-900 p-4 rounded-2xl shadow-lg transform hover:scale-110 transition-transform flex flex-col items-center animate-bounce">
            ...
            <!-- Monedas -->
            <div
                class="bg-orange-100 dark:bg-orange-900 p-4 rounded-2xl shadow-lg transform hover:scale-110 transition-transform flex flex-col items-center animate-bounce delay-75">
            ...
            <!-- Trofeos -->
            <div
                class="bg-green-100 dark:bg-green-900 p-4 rounded-2xl shadow-lg transform hover:scale-110 transition-transform flex flex-col items-center animate-bounce delay-150">
        ...
        <div class="absolute inset-0 pointer-events-none">
            <div class="animate-fall-slow">
                @for ($i = 0; $i < 15; $i++) <span
                    class="absolute w-3 h-3 bg-yellow-400 rounded-full top-0 left-[{{ rand(0, 95) }}%] animate-fall-slow">
                    </span>
                    @endfor
            </div>
        </div>
    ...
    <div class="grid md:grid-cols-3 gap-6">
        ...
        <div
            ...
            <div class="flex gap-4 mt-4 items-center">
                ...
                <span class="text-gray-500 font-semibold ml-2"> Nivel: <strong
                        class="text-green-700 dark:text-green-300">{{ $juego->nivel }}</strong> </span>
            </div>
...
<div x-data="{
    ...
    <div class="bg-white dark:bg-gray-900 rounded-3xl shadow-2xl relative w-full max-w-6xl p-6 md:p-8 flex flex-col max-h-[90vh] overflow-hidden">
        ...
        <button wire:click="cerrarModal"
            class="absolute top-5 right-5 text-gray-600 dark:text-gray-200 hover:text-red-500 text-3xl bg-white dark:bg-gray-800 rounded-full w-10 h-10 flex items-center justify-center shadow-md transition-all hover:scale-110 animate-bounce">
            &times;
        </button>
        ...
        <div class="overflow-y-auto pr-2 flex-1">
            ...
            <div class="text-center mb-6">
                <h2 class="text-4xl md:text-5xl font-extrabold mb-2 text-transparent bg-clip-text bg-gradient-to-r from-pink-500 to-yellow-500 animate-pulse">
            ...
            <div class="flex flex-wrap justify-center gap-4 mb-6 items-center">
                ...
                <!-- Puntos -->
                <div class="flex items-center gap-2 bg-yellow-100 dark:bg-yellow-800 px-4 py-2 rounded-full shadow hover:shadow-lg transition-shadow animate-pulse">
                ...
                <button wire:click="generarPista" wire:loading.attr="disabled" wire:target="generarPista"
                    class="flex items-center gap-2 px-5 py-3 bg-yellow-500 hover:bg-yellow-600 text-white font-bold rounded-full shadow-md text-xl transform hover:scale-110 transition-all">
                    💡 Pista
                </button>

                <!-- Botón Explicación -->
                <button wire:click="pedirExplicacion" wire:loading.attr="disabled" wire:target="pedirExplicacion"
                    class="flex items-center gap-2 px-5 py-3 bg-purple-500 hover:bg-purple-600 text-white font-bold rounded-full shadow-md text-xl transform hover:scale-110 transition-all">
                    📝 Explicación
                </button>
            ...
            <div class="mb-4">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4 p-6">
                    ...
                    <button wire:click="responder('{{ $opcion }}')"
                        class="w-full px-5 py-4 bg-white dark:bg-gray-800 border-2 border-green-300 dark:border-green-600 rounded-2xl font-bold text-lg shadow-md transition-transform hover:scale-100 hover:bg-green-50 dark:hover:bg-green-700 flex items-center justify-center gap-3">
                        <span class="text-xl rounded-full w-10 h-10 flex items-center justify-center bg-gradient-to-tr from-pink-300 to-yellow-300 text-white shadow-lg animate-bounce">
                            {{ chr(65 + $index) }}
                        </span>
                        {{ $opcion }}
                    </button>
                ...
                <div class="my-4 flex items-center justify-center gap-3 text-xl font-bold animate-fade-in">
                    ...
                    <div class="flex items-center gap-3 bg-green-100 dark:bg-green-800 px-4 py-2 rounded-2xl shadow-lg">
                        <i class="fa-solid fa-circle-check text-green-500 text-3xl"></i>
                        <span>{{ $mensajeMotivador }}</span>
                    </div>
                    @else
                    <div class="flex items-center gap-3 bg-red-100 dark:bg-red-800 px-4 py-2 rounded-2xl shadow-lg">
