...
<body>
    ...
    <form class="space-y-6">
        <div class="flex items-center gap-4 bg-white dark:bg-gray-700 rounded-xl shadow-md p-4">
            ...
            <input type="text" placeholder="Nombre" class="w-full border-none focus:ring-0 focus:outline-none text-gray-800 dark:text-gray-100 bg-transparent">
        </div>

        <div class="flex items-center gap-4 bg-white dark:bg-gray-700 rounded-xl shadow-md p-4">
            <i class="fa-solid fa-envelope text-red-600 dark:text-red-400 text-2xl"></i>
            <input type="email" placeholder="Correo" class="w-full border-none focus:ring-0 focus:outline-none text-gray-800 dark:text-gray-100 bg-transparent">
        </div>
        ...
        <div class="flex items-start gap-4 bg-white dark:bg-gray-700 rounded-xl shadow-md p-4">
            ...
            <textarea rows="4" placeholder="Mensaje" class="w-full border-none focus:ring-0 focus:outline-none text-gray-800 dark:text-gray-100 bg-transparent resize-none"></textarea>
        </div>
